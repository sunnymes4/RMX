        ...
        var RenderedCell = (function () {
            ...
            RenderedCell.prototype.setupComponents = function () {
                ...
                if (!this.gridOptionsWrapper.isSuppressCellSelection() && !this.node.floating) {
                    this.vGridCell.setAttribute("tabindex", "none");
                }
        ...
        var RenderedHeaderCell = (function (_super) {
            ...
            RenderedHeaderCell.prototype.addMenu = function () {
                ...
                eMenuButton.onclick = function () {
                    ...
                    that.filterManager.onFilterChanged();
                };
                ...
                if (!this.gridOptionsWrapper.isSuppressMenuHide()) {
                    ...
                    this.eHeaderCell.onmouseover = function () {
                        eMenuButton.style.opacity = '1';
                    };
                    this.eHeaderCell.onmouseout = function () {
                        eMenuButton.style.opacity = '0';
                    };
                }
    ...
    (function (grid) {
        ...
        var PaginationController = (function () {
            ...
            PaginationController.prototype.reset = function () {
                ...
                this.currentPage = this.datasource.pageNo ? this.datasource.pageNo : 0;
